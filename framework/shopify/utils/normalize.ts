...
const normalizeLineItem = ({
  ...
  return {
    ...
    variant: {
      ...
      price: variant?.minVariantPrice.amount,
      listPrice: variant?.maxVariantPrice?.amount,
    },
    ...rest
  }
}
...
const normalizeProductVariants = ({ edges }: ProductVariantConnection) => {
  ...
  return edges.map(({node}) => {
    const { id, selectedOptions, sku, title, minVariantPrice, maxVariantPrice} = node
    ...
    return {
      ...
      listPrice: +maxVariantPrice?.amount,
