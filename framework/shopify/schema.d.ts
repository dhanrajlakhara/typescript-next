...
export type ProductVariant = Node &
  HasMetafields & {
     ...
     * @deprecated Use `maxVariantPrice` instead
     */
    compareAtPrice?: Maybe<Scalars['Money']>
    /** The compare at price of the variant. This can be used to mark a variant as on sale, when `maxVariantPrice` is higher than `minVariantPrice`. */
     ...
     * @deprecated Use `minVariantPrice` instead
     */
    price: Scalars['Money']
    /** The product variant’s price. */
    minVariantPrice: MoneyV2
